...
public class RSAUtil {
	 ...
	 * @throws Exception 加密过程中的异常信息
	 */
	public static String encrypt(String ENSTR) throws Exception{
	 ...
	 * @throws Exception 解密过程中的异常信息
	 */
	public static String decrypt(String DEStr) throws Exception{
	...
	public static void main(String[] args) throws Exception{
		...
		/* Map<String, String> map = new HashMap<String, String>();   
		 map.put("ord666666666666666666erid","001");
		 map.put("uni66666666onname","cyt");	
		 map.put("uni66666666666oncardid","350524198709161538");	
		 map.put("idt6666666666666ype","0");
		 map.put("cou666666666666nt","100");
		 map.put("fina6666666666ncialround","1");	
		 map.put("month666666666price","25");	
		 map.put("monthsellpay","25666666666666666666");	
		 map.put("unionphoto1","ftp://1.png666666666666666");	
		 map.put("Unionphoto2","ftp://1.png6666666666666666666");
		 map.put("date","2016-07-0966666666666666666666666");*/	
		String aa=" {'username':'wolf','price':'2.5','type':'1'}";
	//	 JSONObject jsonObject =  JSONObject.fromObject(map); 
		

		//测试字符串
	//	String encryptStr= jsonObject.toString();

		
			//加密
			String cipher = RSAUtil.encrypt(aa);
